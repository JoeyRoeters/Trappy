...
@section('content')
                                                ...
                                                <div class=" bottom-0 position-absolute">
                                                    <div class="profile-img-content text-dark text-start">
                                                        <div class="text-dark">
                                                            ...
                                                            <h5 class="text-muted">{{ $trap?->location()?->first()?->name }}</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="btn-profile">
                                                    <a class="btn btn-warning mt-1 mb-1" href="{{ route('traps.edit', $trap) }}">
                                                        <i class="fa fa-edit"></i><span>Edit</span>
                                                    </a>
                                                    <form id="delete" action="{{ route('traps.destroy', $trap) }}" method="POST">
                                                        @method('delete')
                                                        @csrf
            ...
            <div class="row">
                <div class="col-xl-3">
                                ...
                                <div class="me-5">
                                    <div class="media mb-4 d-flex">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="fw-semibold fs-25"> {{ count($activities) }} </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                <p>{{ $trap->description ?? 'No description set' }}</p>

                            </div>
                            <hr>
                            <div class="d-flex align-items-center mb-3 mt-3">
                                <div class="me-4 text-center text-primary"> <span><i class="fe fe-activity fs-20"></i></span> </div>
                                <div> <strong>{{ $trap->isOpen ? 'Trap open' : 'Trap closed' }}</strong> </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 mt-3">
                            ...
                            <div class="d-flex align-items-center mb-3 mt-3">
                                <div class="me-4 text-center text-primary"> <span><i class="fe fe-battery fs-20"></i></span> </div>
                                <div> <strong>{{ $trap->battery }}%</strong> </div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    @foreach($activities as $activity)
                                        <li class="d-sm-flex">
                                            <div>
                                                ...
                                                <p class="text-muted fs-12">There was a catch at this trap on location <a href="{{ $activity['url'] }}" class="fw-semibold"> {{ $activity['location'] }}</a></p>
                                            </div>
                                        </li>
                                    @endforeach
                                @endif
    ...
    <script>
        ...
        function deleteLocation() {
            swal({
                    title: "Are you sure?",
                    text: "Trap {{ $title }} will be deleted.",
                    type: "warning",
